...
type Screen struct {
	...
	Panel      Screen_Panel       `protobuf:"varint,3,opt,name=panel,proto3,enum=ci.pcbook.pb.Screen_Panel" json:"panel,omitempty"`
...
var file_screen_message_proto_rawDesc = []byte{
	...
	0x6b, 0x2e, 0x70, 0x62, 0x22, 0x9d, 0x02, 0x0a, 0x06, 0x53, 0x63, 0x72, 0x65, 0x65, 0x6e, 0x12,
	...
	0x32, 0x1f, 0x2e, 0x63, 0x69, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x70, 0x62, 0x2e,
	...
	0x05, 0x70, 0x61, 0x6e, 0x65, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1a, 0x2e, 0x63,
	0x69, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x70, 0x62, 0x2e, 0x53, 0x63, 0x72, 0x65,
	...
	0x45, 0x44, 0x10, 0x02, 0x42, 0x07, 0x5a, 0x05, 0x2e, 0x2e, 0x2f, 0x70, 0x62, 0x62, 0x06, 0x70,
...
var file_screen_message_proto_goTypes = []interface{}{
	(Screen_Panel)(0),         // 0: ci.pcbook.pb.Screen.Panel
	(*Screen)(nil),            // 1: ci.pcbook.pb.Screen
	(*Screen_Resolution)(nil), // 2: ci.pcbook.pb.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: ci.pcbook.pb.Screen.resolution:type_name -> ci.pcbook.pb.Screen.Resolution
	0, // 1: ci.pcbook.pb.Screen.panel:type_name -> ci.pcbook.pb.Screen.Panel
