...
var file_laptop_service_proto_rawDesc = []byte{
	...
	0x52, 0x06, 0x6c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x32, 0xc3, 0x01, 0x0a, 0x0d, 0x4c, 0x61, 0x70,
	0x74, 0x6f, 0x70, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x57, 0x0a, 0x0c, 0x43, 0x72,
	0x65, 0x61, 0x74, 0x65, 0x4c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x12, 0x21, 0x2e, 0x63, 0x69, 0x2e,
	...
	0x65, 0x22, 0x00, 0x12, 0x59, 0x0a, 0x0c, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x4c, 0x61, 0x70,
	0x74, 0x6f, 0x70, 0x12, 0x21, 0x2e, 0x63, 0x69, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e,
	0x70, 0x62, 0x2e, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x4c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x22, 0x2e, 0x63, 0x69, 0x2e, 0x70, 0x63, 0x62, 0x6f,
...
var file_laptop_service_proto_goTypes = []interface{}{
	...
	(*Laptop)(nil),               // 4: ci.pcbook.pb.Laptop
	(*Filter)(nil),               // 5: ci.pcbook.pb.Filter
}
var file_laptop_service_proto_depIdxs = []int32{
	4, // 0: ci.pcbook.pb.CreateLaptopRequest.laptop:type_name -> ci.pcbook.pb.Laptop
	5, // 1: ci.pcbook.pb.SearchLaptopRequest.filter:type_name -> ci.pcbook.pb.Filter
	4, // 2: ci.pcbook.pb.SearchLaptopResponse.laptop:type_name -> ci.pcbook.pb.Laptop
	0, // 3: ci.pcbook.pb.LaptopService.CreateLaptop:input_type -> ci.pcbook.pb.CreateLaptopRequest
	2, // 4: ci.pcbook.pb.LaptopService.SearchLaptop:input_type -> ci.pcbook.pb.SearchLaptopRequest
	1, // 5: ci.pcbook.pb.LaptopService.CreateLaptop:output_type -> ci.pcbook.pb.CreateLaptopResponse
	3, // 6: ci.pcbook.pb.LaptopService.SearchLaptop:output_type -> ci.pcbook.pb.SearchLaptopResponse
...
type LaptopServiceClient interface {
	...
	SearchLaptop(
		ctx context.Context,
		in *SearchLaptopRequest,
		opts ...grpc.CallOption,
	) (LaptopService_SearchLaptopClient, error)
}
...
func (c *laptopServiceClient) CreateLaptop(
	ctx context.Context,
	in *CreateLaptopRequest,
	opts ...grpc.CallOption,
) (*CreateLaptopResponse, error) {
...
func (c *laptopServiceClient) SearchLaptop(
	ctx context.Context,
	in *SearchLaptopRequest,
	opts ...grpc.CallOption,
) (LaptopService_SearchLaptopClient, error) {
	stream, err := c.cc.NewStream(
		ctx,
		&_LaptopService_serviceDesc.Streams[0],
		"/ci.pcbook.pb.LaptopService/SearchLaptop",
		opts...)
	if err != nil {
		return nil, err
	}
...
func _LaptopService_CreateLaptop_Handler(
	srv interface{},
	ctx context.Context,
