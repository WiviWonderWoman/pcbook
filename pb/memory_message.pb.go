...
type Memory struct {
	...
	Unit  Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=ci.pcbook.pb.Memory_Unit" json:"unit,omitempty"`
}
...
var file_memory_message_proto_rawDesc = []byte{
	...
	0x6b, 0x2e, 0x70, 0x62, 0x22, 0xad, 0x01, 0x0a, 0x06, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x12,
	...
	0x01, 0x28, 0x0e, 0x32, 0x19, 0x2e, 0x63, 0x69, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e,
	0x70, 0x62, 0x2e, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x2e, 0x55, 0x6e, 0x69, 0x74, 0x52, 0x04,
	...
	0x54, 0x45, 0x10, 0x06, 0x42, 0x07, 0x5a, 0x05, 0x2e, 0x2e, 0x2f, 0x70, 0x62, 0x62, 0x06, 0x70,
...
var file_memory_message_proto_goTypes = []interface{}{
	(Memory_Unit)(0), // 0: ci.pcbook.pb.Memory.Unit
	(*Memory)(nil),   // 1: ci.pcbook.pb.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: ci.pcbook.pb.Memory.unit:type_name -> ci.pcbook.pb.Memory.Unit
